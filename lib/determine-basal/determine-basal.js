...
var determine_basal = function determine_basal(glucose_status, currenttemp, iob_data, profile, autosens_data, meal_data, tempBasalFunctions, microBolusAllowed, reservoir_data, currentTime, pumphistory, preferences, basalprofile, tdd, tdd_daily, tdd_averages) {
        ...
        var average_7days = 0;
        if (tdd_averages.length > 0) {average_7days = tdd_averages[0].avgTDD7d}
