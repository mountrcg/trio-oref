...
var smbreason = "";  //initialize additional autoisf infos for rT.reason
...
var withinlimitsreason = ""; // initialize additional autoISF infos for rT.reason
...
// Initialize and calculate variables used for predicting BGs
    ...
    if (meal_data.mealCOB > 0 && ( ci > 0 || remainingCIpeak > 0 )) {
        ...
        rT.predBGs.COB = convert_bg(COBpredBGs,profile);
    ...
    if (ci > 0 || remainingCIpeak > 0) {
        if (enableUAM) {
            ...
            rT.predBGs.UAM = convert_bg(UAMpredBGs,profile);
        ...
        rT.eventualBG = convert_bg(eventualBG,profile);
    }
