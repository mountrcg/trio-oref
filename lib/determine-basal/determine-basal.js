...
// Print summary variables based on predBGs etc.
    ...
    var SMBactive = "";
    if (enableSMB) {
        SMBactive = "SMB's enabled, "
    } else {
        SMBactive = "SMB's disabled, ";
        SMBdelreason = "";
    };
    rT.reason = SMBactive + SMBdelreason + isfreason + ", Standard, COB: " + rT.COB + ", Dev: " + rT.deviation + ", BGI: " + rT.BGI+ ", ISF: " + rT.ISF + ", CR: " + rT.CR + ", Target: " + rT.target_bg + ", minPredBG " + convert_bg(minPredBG, profile) + ", minGuardBG " + convert_bg(minGuardBG, profile) + ", IOBpredBG " + convert_bg(lastIOBpredBG, profile);
    if (lastCOBpredBG > 0) {
