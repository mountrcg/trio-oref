...
//    var sensitivityRatio;
    ...
    //}
     ...
     if (oref2_variables.isEnabled) {
         ...
         console.log("Custom Half Basal Target used: " + convert_bg(newHalfBasalTarget, profile) + " " + profile.out_units);
    ...
    console.log("Target Behavior settings: highTTraisesSens is " + profile.high_temptarget_raises_sensitivity + ", lowTTlowersSens is " + profile.low_temptarget_lowers_sensitivity + ", HBT configured is " +  profile.half_basal_exercise_target);
