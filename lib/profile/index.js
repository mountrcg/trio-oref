...
function defaults ( ) {
  return /* profile */ {
    ...
    , keto_protect_basal: 0.2 // Percentage of the small safety TBR in % which is given to avoid ketoacidosis.
  }
}
...
function displayedDefaults () {
    ...
    profile.keto_protect_basal = allDefaults.keto_protect_basal;
