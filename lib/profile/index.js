...
function defaults ( ) {
  return /* profile */ {
    ...
    , autoisf_temp_smb: false // let autoisf switch SMB off with odd temp targets and enforce SMB with even TT
...
function displayedDefaults () {
    ...
    profile.autoisf_temp_smb = allDefaults.autoisf_temp_smb;
