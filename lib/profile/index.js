...
function defaults ( ) {
  return /* profile */ {
    ...
    // autoISF variables
    , use_autoisf: false // Defaults to false. Enable to use autoISF & SMB Range extension.customizable BG threshold ration for
    , smb_threshold_ratio: 0.5 //  SMB's, used in formula threshold = min_bg - (1-threshold_ratio) * (min_bg - 40); default and min value 0.5. The higher the ratio the higher the threshold for SMB's to be applied.
