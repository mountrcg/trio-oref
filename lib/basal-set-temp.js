...
tempBasalFunctions.setTempBasal = function setTempBasal(rate, duration, profile, rT, currenttemp) {
    ...
    var ketoReason = "";
    var ketoProtectBasalpercent = 20;
    var ketoProtectBasalabsolute = 0;
    var cutoff = 0;
    if (profile.keto_protect_basal_percent) {
      ketoProtectBasalpercent = Math.min(Math.max(profile.keto_protect_basal_percent,5),50)  //protectBasal as percentage can be between 5 and 50%
